...
const NPCS = {
  ...
  tanuki:  {emoji:"🦝", name:["Tanuki the Innkeeper","たぬきの【宿主|やどぬし】"]},
...
{id:"q3_2", ch:3, npc:"kitsune", title:["This, That, What?","これ？それ？なに？"],
 intro:[
  ...
  ["kitsune",null,"And your first grammar: 「〜は〜です」. Say 'X wa Y desu' — no wait, listen 🔊, never read it in foreign letters: 「わたしは カモです。」"]],
 steps:[{t:"learn",kind:"vocab",items:["わたし","あなた","これ","それ","あれ","ここ","そこ","あそこ","だれ","なに","どこ","いつ","どれ","いくら","みんな"]},
...
{id:"q3_3", ch:3, npc:"kuma", title:["The Price of Honey","はちみつの ねだん"],
 ...
 steps:[{t:"learn",kind:"vocab",items:["いち","に","さん","よん","ご","ろく","なな","はち","きゅう","じゅう","ひゃく","せん","まん","えん","おかね"]},
        {t:"learn",kind:"kanji",items:["一","二","三","四","五","六","七","八","九","十","百","千","万","円"]},
        {t:"quiz",n:12,pass:9}],
 outro:[["kuma",null,"「はちみつは 三百{えん}です！」Cheap! Come again!"]],
...
{id:"q5_2", ch:5, npc:"inu", title:["Seven Days","一しゅうかん"],
 intro:[
 ...
 steps:[{t:"learn",kind:"vocab",items:["げつようび","かようび","すいようび","もくようび","きんようび","どようび","にちようび","せんしゅう","こんしゅう","らいしゅう","ことし","きょねん","らいねん"]},
        {t:"learn",kind:"vocab",items:["おきる","ねる","やすむ","あるく","はしる","まつ","あう","つくる","あそぶ","およぐ","うたう","たつ","すわる","はいる","でる","のる","わかる","おしえる","ならう","べんきょうする"]},
...
{id:"q5_4", ch:5, npc:"fukurou", title:["Body and Sky","からだと そら"],
 ...
 steps:[{t:"learn",kind:"vocab",items:["あたま","かお","め","みみ","はな","くち","て","あし","おなか","てんき","あめ","はれ","そら","やま","かわ","うみ"]},
...
{id:"q5_5", ch:5, npc:"kame", title:["The Elder's Compass","ちょうろうの らしんばん"],
 ...
 steps:[{t:"learn",kind:"vocab",items:["きた","みなみ","ひがし","にし","ときどき","いつも","とても","すこし","たくさん","ちょっと","まだ","もう","いっしょに"]},
...
{id:"q6_1", ch:6, npc:"tanuki", title:[null,"はたらく ことば"],
 ...
 steps:[{t:"learn",kind:"vocab",items:["しごと","かいしゃ","いしゃ","けいさつ","うんてん","きゅうりょう","かいぎ","うけつけ","ぎんこう","びょういん","ゆうびんきょく","はたらく","りょかん","ばしょ"]},
...
{id:"q6_2", ch:6, npc:"tora", title:[null,"みやこの きそく"],
 ...
 steps:[{t:"learn",kind:"vocab",items:["きそく","ちゅうい","あぶない","あんぜん","じゆう","たいせつ","ちこく","おくれる","まにあう","いそぐ","とどく","きめる"]},
...
{id:"q7_1", ch:7, npc:"miko", title:[null,"こころの ことば"],
 ...
 steps:[{t:"learn",kind:"vocab",items:["こころ","きもち","ゆめ","おもう","いう","しらべる","おぼえる","わすれる","いみ","ことば","こたえ","もんだい"]},
...
{id:"q7_2", ch:7, npc:"miko", title:[null,"しきの やま"],
 ...
 steps:[{t:"learn",kind:"vocab",items:["はる","なつ","あき","ふゆ","あたたかい","すずしい","もり","いけ","みずうみ","ほし","つき","ひかり","くもり","ゆうがた","しま","かぜ","ゆき"]},
...
{id:"q7_5", ch:7, npc:"ryu", title:[null,"りゅうの ためし"],
 ...
 steps:[{t:"learn",kind:"vocab",items:["せかい","ぶんか","れきし","ぶんぽう","じ","はつおん","けいけん","しゅみ","りゆう","せつめい","けんきゅう","じゅぎょう","しゅくだい","しけん"]},
...
const GQUIZ = [
 ...
 {g:"g_desu", q:"これは みず＿＿。", opts:["です","ます","か","の"], a:0},
 ...
 {g:"g_ni", q:"七時＿＿おきます。", opts:["に","を","で","が"], a:0},
 {g:"g_de", q:"としょかん＿＿べんきょうします。", opts:["で","に","を","の"], a:0},
 {g:"g_e", q:"うみ＿＿いきます。", opts:["へ","を","が","の"], a:0},
 {g:"g_masu", q:"まいにち パンを たべ＿＿。", opts:["ます","ました","です","たい"], a:0},
 ...
 {g:"g_mashou", q:"いっしょに いき＿＿＿＿。", opts:["ましょう","たいです","てください","ませんでした"], a:0},
 {g:"g_kara", q:"さむいです＿＿、うちに います。", opts:["から","まで","のに","が"], a:0},
 ...
 {g:"g_nai", q:"【肉|にく】を【食|た】べ＿＿。（ふつうたい・ひてい）", opts:["ない","ません","なかった","じゃない"], a:0},
 {g:"g_nakereba", q:"【宿題|しゅくだい】を し＿＿＿＿＿ならない。", opts:["なければ","なくても","ないでは","なくれば"], a:0},
 {g:"g_temoii", q:"ここで【写真|しゃしん】を とっ＿＿＿＿ですか。", opts:["てもいい","てはいけない","ておく","てしまう"], a:0},
 ...
 {g:"g_tsumori", q:"【来年|らいねん】、【旅行|りょこう】する＿＿＿＿です。", opts:["つもり","はず","そう","ため"], a:0},
 ...
 {g:"g_teshimau", q:"ケーキを ぜんぶ【食|た】べ＿＿＿＿＿＿。", opts:["てしまいました","ておきました","ていました","てありました"], a:0},
 ...
 {g:"g_shieki", q:"【母|はは】は【弟|おとうと】に【野菜|やさい】を【食|た】べ＿＿＿＿。", opts:["させました","られました","てあげました","ておきました"], a:0},
 ...
 {g:"g_hazu", q:"【荷物|にもつ】は【明日|あした】【届|とど】く＿＿です。", opts:["はず","かも","そう","まま"], a:0},
